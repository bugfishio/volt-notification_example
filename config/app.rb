...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-notification-example.com'
  config.app_name = 'Volt-notification_example'
  config.mailer.from = 'Volt-notification_example <no-reply@volt-notification-example.com>'
  ...
  #
  config.app_secret = 'DXSNU0MrvOuwJk5yme6uAxmNquU5D83Vh2btHfs2Ezv5OgDhIKF4FpPNXJOXSy8SkJc'
